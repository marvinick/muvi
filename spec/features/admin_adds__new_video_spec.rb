...
feature "Admin addds new video" do
  scenario 'Admin successfully adds a new video' do
    ...
    fill_in"Video URL", with: "http://www.yahoo.com/my_video.mp4"
    ...
    expect(page).to have_selector("a[href='http://www.yahoo.com/my_video.mp4']")
  end
end